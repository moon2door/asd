...
//#include "Utility/mathematics.h"
//
//void CCollisionProcessorManagerDlg::OnTimerConnetDBMS()
//{
//	if (m_dbConnector->IsConneted() == false)
//	{
//		int32_t dbPort = 9433;
//		std::string dbIP = Routine::GetConfigString("DB", "IP", "60.100.150.30");
//		dbPort = Routine::GetConfigInt("DB", "Port", dbPort);
//		std::string dbName = Routine::GetConfigString("DB", "DATABASE", "CAC");
//		std::string dbID = Routine::GetConfigString("DB", "ID", "CACDBUSER");
//		std::string dbPassword = Routine::GetConfigString("DB", "PASS", "Cacpw!!!###");
//		if (m_dbConnector->Connect(dbIP.data(), dbPort, dbName.data(), dbID.data(), dbPassword.data()))
//		{
//			// Crane 정보 
//			m_dbConnector->RequestCraneInfo();
//
//			SetDlgItemText(IDC_TXT_DB_CONNECTION, "Connected");
//
//			StartTimerUpdateHeading();
//			StartTimerUpdateCooperation();
//			m_dbConnector->ClearCraneDataAll();
//		}
//	}
//	else StopTimerConnetDBMS();
//}
//
...
//}
//
//void CCollisionProcessorManagerDlg::OnTimerUpdateCraneInfo()
//{
//	if (m_objSensorManager->GetSocketTCP()->GetClientInfo().size())
//	{
//		m_dbConnector->RequestCraneInfo(m_dbConnector->GetCraneNumber(GetCraneName(GetRotorStatus().Crane)));
//
//		SHI::Object::StCraneInfoDB tmp = m_dbConnector->GetHookInfo();
//		SHI::Data::StDBInfo data;
//		memcpy(&data, &tmp, sizeof(data));
//		data.latitude = m_dbConnector->GetLat();
//		data.logitude = m_dbConnector->GetLon();
//		GetStubDBInfo()->WriteData(&data);
//	}
//}
//
//void CCollisionProcessorManagerDlg::OnTimerUpdateCooperation()
//{
//	if (m_objSensorManager->GetSocketTCP()->GetClientInfo().size())
//	{
//		m_dbConnector->RequestCooperation(m_dbConnector->GetCraneNumber(GetCraneName(GetRotorStatus().Crane)));
//	}
//}
//
//void CCollisionProcessorManagerDlg::OnUpdatedDistance()
//{
...
//		offX = 0;
//		offY = 0;
//		offZ = 52.3215f - m_dbConnector->GetHeight();
//		azimuth = -m_dbConnector->GetHeading();
//		break;
//	case 4:
//		offX = 0;
//		offY = 0;
//		offZ = 42.46f - m_dbConnector->GetHeight();
//		azimuth = -m_dbConnector->GetHeading();
//		break;
//	case 5:
//		offX = 0;
//		offY = 0;
//		offZ = 51.3215f - m_dbConnector->GetHeight();
//		azimuth = -m_dbConnector->GetHeading();
//		break;
//	case 6:
//		offX = 0;
//		offY = 0;
//		offZ = 54.f - m_dbConnector->GetHeight();
//		azimuth = -m_dbConnector->GetHeading();
//		break;
//	case 7:
//		offX = 0;
//		offY = 0;
//		offZ = 48.5f - m_dbConnector->GetHeight();
//		azimuth = -m_dbConnector->GetHeading();
//		break;
//	default:
//		break;
...
//			}
//
//			//printf("%d ( %s ) \n", i, m_dbConnector->PushData(GetCraneName(GetRotorStatus().NumCrane), i, strTime, resCvt.point, v2Points[i].Distance, v2Points[i].CollisionInfo) ? "True" : "False");
//		}
//	}
//	else
//	{
